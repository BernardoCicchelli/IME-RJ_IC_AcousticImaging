clear; close all; clc;
%==========================================================================
% DAMAS — Aplicação nos SINAIS REAIS do projeto IME
% Pipeline DAMAS já validado no exemplo simulado. Aqui o snapshots vem dos
% .wav reais (2 caixas em 700 Hz, ambiente não anecoico).
% Grid em 1 grau, largo o suficiente para cobrir as duas caixas.
%==========================================================================
